...
<div id="event-create-container" class="col-md-6 offset-md-3">
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="fornecedor" name="fornecedor" placeholder="Codigo Fornecedor" required>
    </div>
    <div class="form-group">
        <label for="titulo">Lote:</label>
        <input type="text" class="form-control" id="lote" name="lote" placeholder="Codigo do Lote" required>
    </div>
    <div class="form-group span9">
